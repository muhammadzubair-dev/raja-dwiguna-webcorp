  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        />
        <Route
          path={`${process.env.PUBLIC_URL}/general-contracting`}
          exact
          element={<GeneralContracting />}
        />
        <Route
          path={`${process.env.PUBLIC_URL}/metrial-managment`}
          exact
          element={<MetrialManagment />}
        />
        <Route
          path={`${process.env.PUBLIC_URL}/building-renovation`}
          exact
          element={<BuildingRenovation />}
        />
        <Route
          path={`${process.env.PUBLIC_URL}/architecture-design`}
          exact
          element={<ArchitectureDesign />}
        />
        <Route
          path={`${process.env.PUBLIC_URL}/multistory-build`}
          exact
          element={<MultistoryBuild />}
        />
        <Route
